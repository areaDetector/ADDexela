...
/// </summary>
#define DigitalBinBit 2
/// <summary>
/// Constant for digital binning bit
/// </summary>
#define ForceFPGABinningBit 16
/// <summary>
...
/// <summary>
/// Address of sensor version register. The high byte is sensor version and the
/// low byte is detector version. For Hercules, sensor version is 0x01 and
/// detector version is 0x01 for 1512 and 0x02 for 1207.
/// </summary>
#define AddrSensorVersion 129
/// <summary>
/// Hercules ADC control register
/// </summary>
#define AddrHerculesAdcControlRegister 401
...
#define XIS_MULTIGAIN_CORRECTED \
	8 /*this is not currently used appart from in XIS*/
...
// this flag indicates the presence of new parameters SensorVersion,
// InterlacingType, RoiEnabled and CapturedROI in the HIS header
#define DEX_EXTRA_PARAMS_FLAG_2 0x2000
#define CLEAR_DEX_EXTRA_PARAMS_FLAG_2 0xDFFF
// this flag will indicate the presence of new parameters (e.g. model, binning,
// operations) in the HIS header
#define DEX_EXTRA_PARAMS_FLAG 0x4000
...
#define LINEARIZATION_ENABLE_FLAG 0xFFFB
#define LINEARIZATION_DISABLE_FLAG 0x4
#define XTALK_CORRECTION_ENABLE_FLAG 0x4000
#define XTALK_CORRECTION_DISABLE_FLAG 0xBFFF

#define TIFFTAG_DEX_CORRECTION_FLAGS \
	34595 /* New tiff-tag for storing correction flags parameter */
#define TIFFTAG_DEX_OPERATION_FLAGS \
	34596 /* New tiff-tag for storing operation flags parameter */
#define TIFFTAG_DEX_IMAGE_TYPE \
	34597                    /* New tiff-tag for storing image-type parameter */
...
#define TIFFTAG_DEX_MODEL_NUM \
	34598 /* New tiff-tag for storing image-type parameter */
...
#define TIFFTAG_SLICE_INTERLACING 34603
#define TIFFTAG_ROI_ENABLED 34604
#define TIFFTAG_DEX_SENSOR_VERSION 34605
#define TIFFTAG_CAPTURED_ROI_STARTCOL 34606
#define TIFFTAG_CAPTURED_ROI_STARTROW 34607
#define TIFFTAG_CAPTURED_ROI_WIDTH 34608
#define TIFFTAG_CAPTURED_ROI_HEIGHT 34609
#define TIFFTAG_METADATA_BYTECOUNT 50838
#define TIFFTAG_METADATA 50839
